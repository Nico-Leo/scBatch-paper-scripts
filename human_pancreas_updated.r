...
p5 = ggplot(plotlimma,aes(x=TSNE1, y=TSNE2)) + geom_point(size=1,aes(color=cell.type)) + ggtitle('limma') + theme_classic()+
  theme(title = element_text(size = rel(1.5)),
        axis.title.x = element_text(size = rel(1)),
        axis.title.y = element_text(size = rel(1)),
        legend.text = element_text(size = rel(1.5)),
...
p6 = ggplot(plotbatchelor,aes(x=TSNE1, y=TSNE2)) + geom_point(size=1,aes(color=cell.type)) + ggtitle('rescaleBatches') + theme_classic()+
  theme(title = element_text(size = rel(1.5)),
        axis.title.x = element_text(size = rel(1)),
        axis.title.y = element_text(size = rel(1)),
        legend.text = element_text(size = rel(1.5)),
...
ggsave("Revision_Figures/xin_cell_tsne.png",plot=grid_arrange_shared_legend(p1,p2,p3,p4,p5,p6,nrow=2,ncol=3),device="png",height=10,width=16)
ggsave("Revision_Figures/xin_cell_tsne.eps",plot=grid_arrange_shared_legend(p1,p2,p3,p4,p5,p6,nrow=2,ncol=3),device="eps",height=10,width=16,dpi=300)
...
p5 = ggplot(plotlimma,aes(x=TSNE1, y=TSNE2, color=GCG)) + geom_point(size=1) + ggtitle('limma') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")

plotbatchelor$GCG = batchelormod['GCG',]
p6 = ggplot(plotbatchelor,aes(x=TSNE1, y=TSNE2, color=GCG)) + geom_point(size=1) + ggtitle('rescaleBatches') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")


ggsave("Revision_Figures/xin_GCG_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=12)
ggsave("Revision_Figures/xin_GCG_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
p5 = ggplot(plotlimma,aes(x=TSNE1, y=TSNE2, color=INS)) + geom_point(size=1) + ggtitle('limma') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")

plotbatchelor$INS = batchelormod['INS',]
p6 = ggplot(plotbatchelor,aes(x=TSNE1, y=TSNE2, color=INS)) + geom_point(size=1) + ggtitle('rescaleBatches') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")


ggsave("Revision_Figures/xin_INS_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=12)
ggsave("Revision_Figures/xin_INS_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
p5 = ggplot(plotlimma,aes(x=TSNE1, y=TSNE2, color=PPY)) + geom_point(size=1) + ggtitle('limma') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")

plotbatchelor$PPY = batchelormod['PPY',]
p6 = ggplot(plotbatchelor,aes(x=TSNE1, y=TSNE2, color=PPY)) + geom_point(size=1) + ggtitle('rescaleBatches') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")


ggsave("Revision_Figures/xin_PPY_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=12)
ggsave("Revision_Figures/xin_PPY_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
p5 = ggplot(plotlimma,aes(x=TSNE1, y=TSNE2, color=SST)) + geom_point(size=1) + ggtitle('limma') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")

plotbatchelor$SST = batchelormod['SST',]
p6 = ggplot(plotbatchelor,aes(x=TSNE1, y=TSNE2, color=SST)) + geom_point(size=1) + ggtitle('rescaleBatches') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")


ggsave("Revision_Figures/xin_SST_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=12)
ggsave("Revision_Figures/xin_SST_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
p6 = ggplot(plotbatchelor,aes(x=PC1 , y=PC2)) + geom_point(size=1,aes(color=cell.type)) + ggtitle('rescaleBatches') + theme_classic()

ggsave("Revision_Figures/xin_cell_PCA.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16)
ggsave("Revision_Figures/xin_cell_PCA.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
p6 = ggplot(plotbatchelor,aes(x=UMAP1, y=UMAP2)) + geom_point(size=1,aes(color=cell.type)) + ggtitle('rescaleBatches') + theme_classic()

ggsave("Revision_Figures/xin_cell_umap.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16,dpi=300)
ggsave("Revision_Figures/xin_cell_umap.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/xin_kBET.png",plot=pkbet,device="png",height=4,width=6)
ggsave("Revision_Figures/xin_kBET.eps",plot=pkbet,device="eps",height=4,width=6,dpi=300)
...
save(DEmnn,file='Revision_Figures/DEmnnfiltered_xin.rdata')
save(DEscbatch,file='Revision_Figures/DEscbatchfiltered_xin.rdata')
save(DEcombat,file='Revision_Figures/DEcombatfiltered_xin.rdata')
save(DEraw,file='Revision_Figures/DErawfiltered_xin.rdata')
save(DElimma,file='Revision_Figures/DElimmafiltered_xin.rdata')
save(DErescale,file='Revision_Figures/DErescalefiltered_xin.rdata')
...
for (i in 1:6){
  ...
  if (i %in% c(5)){
    V[[i]] <- plot(Vstem,quantities=T,lty=1:6,label=F,main=paste(groups[1],'vs',groups[2],sep=' '),legend=list(nrow=3,ncol=2,fontsize=15,font=1))
  }else{
...
ggsave("Revision_Figures/xin_venn.png",plot=grid.arrange(V[[1]],V[[2]],V[[3]],V[[4]],V[[5]],V[[6]],nrow=2)
       ,device="png",height=8,width=16,dpi=300)
ggsave("Revision_Figures/xin_venn.eps",plot=grid.arrange(V[[1]],V[[2]],V[[3]],V[[4]],V[[5]],V[[6]],nrow=2)
...
for (i in 1:6){
  ...
  DElist<-list(Uncorrected = as.vector(DEraw[[i]]), ComBat = as.vector(DEcombat[[i]]), 
               MNN = as.vector(DEmnn[[i]]),scBatch = as.vector(DEscbatch[[i]]),
               limma = as.vector(DElimma[[i]]), rescaleBatches = as.vector(DErescale[[i]]))
  save(DElist,file=paste('Revision_Figures/xinfiltered_',groups[1],'_',groups[2],'.rdata',sep=''))
}
...
setwd('Revision_Figures/xin/DElist')
