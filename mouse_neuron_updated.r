...
ggsave("Revision_Figures/usoskin_cell_tsne.png",plot=grid_arrange_shared_legend(p1,p2,p3,p4,p5,p6,nrow=2,ncol=3),device="png",height=8,width=16,dpi=300)
ggsave("Revision_Figures/usoskin_cell_tsne.eps",plot=grid_arrange_shared_legend(p1,p2,p3,p4,p5,p6,nrow=2,ncol=3),device="eps",height=10,width=16,dpi=300)
...
p5 = ggplot(plotlimma,aes(x=TSNE1, y=TSNE2, color=Tac1)) + geom_point(size=1) + ggtitle('limma') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")

plotbatchelor$Tac1 = batchelormod['Tac1',]
p6 = ggplot(plotbatchelor,aes(x=TSNE1, y=TSNE2, color=Tac1)) + geom_point(size=1) + ggtitle('rescaleBatches') + theme_classic()+ scale_color_distiller(palette = "YlOrRd")


ggsave("Revision_Figures/usoskin_Tac1_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16)
ggsave("Revision_Figures/usoskin_Tac1_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/usoskin_Th_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16)
ggsave("Revision_Figures/usoskin_Th_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/usoskin_Nefh_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16)
ggsave("Revision_Figures/usoskin_Nefh_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/usoskin_Mrgprd_tsne.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16)
ggsave("Revision_Figures/usoskin_Mrgprd_tsne.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/usoskin_cell_PCA.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16)
ggsave("Revision_Figures/usoskin_cell_PCA.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/usoskin_cell_umap.png",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="png",height=8,width=16,dpi=300)
ggsave("Revision_Figures/usoskin_cell_umap.eps",plot=grid.arrange(p1,p2,p3,p4,p5,p6,nrow=2),device="eps",height=8,width=16,dpi=300)
...
ggsave("Revision_Figures/usoskin_kBET.png",plot=pkbet,device="png",height=4,width=6)
ggsave("Revision_Figures/usoskin_kBET.eps",plot=pkbet,device="eps",height=4,width=6,dpi=300)
...
save(DEmnn,file='Revision_Figures/DEmnn610_usoskin.rdata')
save(DEscbatch,file='Revision_Figures/DEscbatch610_usoskin.rdata')
save(DEcombat,file='Revision_Figures/DEcombat610_usoskin.rdata')
save(DEraw,file='Revision_Figures/DEraw610_usoskin.rdata')
save(DElimma,file='Revision_Figures/DElimma610_usoskin.rdata')
save(DErescale,file='Revision_Figures/DErescale610_usoskin.rdata')


library(eulerr)
V = list()
eulerr_options(legend=list(font=2,byrow=F,side='bottom',nrow=2,ncol=3))
#library(gridExtra)
for (i in 1:6){
  groups = combn(c('NP','NF','TH','PEP'),2)[,i]
...
grid_arrange_shared_legend(V[[1]],V[[2]],V[[3]],V[[4]],V[[5]],V[[6]],nrow=2)
ggsave("Revision_Figures/usoskin_venn.png",plot=grid.arrange(V[[1]],V[[2]],V[[3]],V[[4]],V[[5]],V[[6]],nrow=2)
       ,device="png",height=8,width=16,dpi=300)
ggsave("Revision_Figures/usoskin_venn.eps",plot=grid.arrange(V[[1]],V[[2]],V[[3]],V[[4]],V[[5]],V[[6]],nrow=2)
...
for (i in 1:6){
  ...
  DElist<-list(Uncorrected = as.vector(DEraw[[i]]), ComBat = as.vector(DEcombat[[i]]), 
               MNN = as.vector(DEmnn[[i]]),scBatch = as.vector(DEscbatch[[i]]),
               limma = as.vector(DElimma[[i]]), RescaleBatches = as.vector(DErescale[[i]]))
  save(DElist,file=paste('Revision_Figures/usoskin/Usoskin610_',group[1],'_',group[2],'.rdata',sep=''))
}
...
setwd('Revision_Figures/usoskin/DElist')
